...
export var generarNombresProveedor = (data) => {
    var arr = [];
...
export var generarTotalProveedor = (data, length) => {
    let temp = 0;
    let arr = [];
    ...
    for (let i = 0; i < data.length; i++) {
        temp = arr[(data[i].Id_Proveedor) - 1];
        if (temp !== undefined) {
            arr[(data[i].Id_Proveedor) - 1] = temp + data[i].Gasto;
        }
        else {
...
export var totalGastadoProveedor = (arr) => {
    let totalGastado = 0;
...
export var proveedorPorcentaje = (arr, totalGastado) => {
    let temp = 0;
...
export var construirDataSetProveedor = (arr1, arr2) => {
    let arrResultante = [];
...
export var proveedorMasComprado = (data) => {
    let proveedorMasFrecuente = data[0].totalGastado;
    let nombreProveedor = data[0].proveedor;
    for (let i = 0; i < data.length; i++) {
        if (data[i].totalGastado >= proveedorMasFrecuente) {
            proveedorMasFrecuente = data[i].totalGastado;
            nombreProveedor = data[i].proveedor;
        }
    }
    return nombreProveedor;
}

export var proveedorMenosComprado = (data) => {
    let proveedorMenosFrecuente = data[0].totalGastado;
    let nombreProveedor = data[0].proveedor;
    for (let i = 0; i < data.length; i++) {
        if (data[i].totalGastado <= proveedorMenosFrecuente) {
            proveedorMenosFrecuente = data[i].totalGastado;
            nombreProveedor = data[i].proveedor;
        }
    }
    return nombreProveedor;
